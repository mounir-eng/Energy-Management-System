...
A real-time energy monitoring and optimization dashboard for buildings with PV generation, battery storage, and mixed utility loads. Built with Streamlit.
...
Prosumers optimizing battery charge/discharge cycles

Facility operators identifying peak load reduction opportunities

Educational tool for energy system modeling
...
Plotly for interactive charts (line, area, bar, Sankey)
